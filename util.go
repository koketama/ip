...
func MkZone(name, url string) (*Zone, error) {
	...
	if err != nil {
		return nil, errors.WithMessagef(err, "http get %s err", url)
	}
	...
	if resp.StatusCode != http.StatusOK {
		...
		if err != nil {
			return nil, errors.WithMessage(err, "read resp body err")
		}
	...
	if err = scanner.Err(); err != nil {
		return nil, errors.WithMessage(err, "scan resp body err")
	}
